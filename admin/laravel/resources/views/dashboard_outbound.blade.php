...
@section('page_heading','Outbound Transactions')
@section('section')
            ...
            <div class="col-lg-12">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">Requests To and Responses From</h3>
                    </div>
                    ...
                    <div class="panel-body visible-md-block visible-lg-block">
                        <table class="table table-bordered" style="text-align:right;width:100%;">
                            ...
                            <tr>
                                ...
                                <th colspan="3" class="text-center">REQUESTS TO</th>
                                <th colspan="4" class="text-center">RESPONSES FROM</th>
                            </tr>
                            <tr>
